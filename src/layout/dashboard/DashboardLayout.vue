<template>
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        <sidebar-link to="/services" name="Services" icon="tim-icons icon-cloud-download-93" />
        <sidebar-link to="/metrics" name="Metrics" icon="tim-icons icon-chart-bar-32" />
        <sidebar-link to="/customers" name="Customers" icon="tim-icons icon-single-02" />
